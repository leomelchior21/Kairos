...
const FLOW_LIBRARY = {
  concept: [
    { id: 'hook', label: 'Hook', interaction: 'multiple_choice', goal: 'Choose the best lens for the idea.' },
    { id: 'prior_knowledge', label: 'Prior knowledge', interaction: 'true_false', goal: 'Test one safe claim.' },
    { id: 'guided_discovery', label: 'Guided discovery', interaction: 'match', goal: 'Match examples to concepts.' },
    { id: 'checkpoint', label: 'Checkpoint', interaction: 'multiple_choice', goal: 'Pick the strongest meaning.' },
    { id: 'synthesis_challenge', label: 'Synthesis', interaction: 'fill_blanks', goal: 'Complete the concept sentence.' },
    { id: 'final_reveal', label: 'Final reveal', interaction: 'final_reveal', goal: 'Confirm the answer earned by reasoning.' },
  ],
  fact: [
    { id: 'hook', label: 'Hook', interaction: 'multiple_choice', goal: 'Identify what kind of fact is needed.' },
    { id: 'prior_knowledge', label: 'Prior knowledge', interaction: 'true_false', goal: 'Separate clue from distraction.' },
    { id: 'guided_discovery', label: 'Guided discovery', interaction: 'multiple_choice', goal: 'Choose the deciding evidence.' },
  ...
  comparison: [
    { id: 'hook', label: 'Hook', interaction: 'tap_choice', goal: 'Choose the comparison axis.' },
